...
hl.bind(secondMod .. " + space", hl.dsp.exec_cmd(wallpaper))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(music))
hl.bind(mainMod .. " + Q", hl.dsp.window.close())

--hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("hyprctl switchxkblayout current next"))

hl.bind(secondMod .. " + R", hl.dsp.exec_cmd("hyprshutdown -t 'Restarting...' --post-cmd 'reboot'"))
...
hl.bind(secondMod .. "+ W", hl.dsp.exec_cmd("hyprlock"))
